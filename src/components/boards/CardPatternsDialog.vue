  ...
  >
    <q-card class="patterns-dialog">
      <div class="patterns-header">
        ...
        <q-btn flat round dense icon="close" class="header-close" @click="$emit('update:modelValue', false)" />
      </div>
      ...
      <div class="patterns-body">
        ...
        <template v-else>
          <div v-if="patterns.length === 0" class="patterns-empty">
...
const emit = defineEmits(['update:modelValue', 'usePattern', 'createPattern'])
